    ...
    return (
        <div
            ...
            <div className="flex flex-col ml-8 projectDescription">
                ...
                <p className="text-black">Used deep learning frameworks MediaPipe and OpenCV to accurately detect and track shoulder press exercises.
                ...
                <p className={"text-gray-400 cursor-pointer hover:text-[#8477ff] transition-all underline demoLinks"} onClick={handleGithubProject3Link}>Github Link</p>
